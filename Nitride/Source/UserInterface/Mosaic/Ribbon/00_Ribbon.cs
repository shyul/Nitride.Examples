...
namespace Nitride
{
    ...
    public class Ribbon : ContainerControl
    {
        ...
        public static Color OrbDarkColor { get; set; } = Color.FromArgb(255, 32, 70, 80);
        public static Color OrbLightColor { get; set; } = Color.FromArgb(255, 80, 120, 140);
        public static Color OrbHoverDarkColor { get; set; } = Color.FromArgb(255, 60, 110, 120);
        public static Color OrbHoverLightColor { get; set; } = Color.FromArgb(255, 100, 140, 160);
        #endregion
