...
namespace Nitride
{
    ...
    public static class Icons
    {
        ...
        public static readonly Dictionary<Size, Bitmap> Caption_Minimize = new() {
            { new Size(16, 16), Properties.Resources.Caption_Minimize },
        };

        public static readonly Dictionary<Size, Bitmap> Caption_Maximize = new() {
            { new Size(16, 16), Properties.Resources.Caption_Maximize },
        };

        public static readonly Dictionary<Size, Bitmap> Caption_Restore = new() {
            { new Size(16, 16), Properties.Resources.Caption_RestoreNormal },
        };

        public static readonly Dictionary<Size, Bitmap> Caption_Close = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> File_Open = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> File_Save = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Clip_Copy = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Clip_Cut = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Clip_Paste = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Erase = new() {
            { new Size(16, 16), Properties.Resources.Eraser_16 },
            { new Size(24, 24), Properties.Resources.Eraser_24 }
        };

        public static readonly Dictionary<Size, Bitmap> Plus = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Minus = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Stop = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Log_Info = new() {
        ...
        public static readonly Dictionary<Size, Bitmap> Log_Plus = new() {
