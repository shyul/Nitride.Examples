...
module grid_top (
	...
	input	analog_clk_in_N, analog_clk_in_P,
...
wire    clk0, analog_clk, clk_synce;
wire    clk0_g, clk1_g, clk2_g, analog_clk_g;
...
IBUFDS clk_analog_buf (.O (analog_clk), .I(analog_clk_in_P), .IB(analog_clk_in_N));
BUFG clk_analog_bufg (.O(analog_clk_g), .I(analog_clk));
...
assign  dac_dclk_2x = analog_clk_g; //clk0_g;
...
assign	rf_clk_spi_cs_b = emio_spi_cs_b_0;
...
wire    adc_clk;
wire pl_clk_100MHz, pl_reset_b;
reg [26:0] counter = 0;

always_ff@(posedge adc_clk) begin//analog_clk_g) begin //pl_clk_100MHz) begin
	counter++;
end

assign pl_led_pps = counter[24];
...
grid grid_inst(
    ...
    .emio_spi0_m_i(mux_spi_di),
    .emio_spi0_m_o(emio_spi_do),
    .emio_spi0_s_i(emio_spi_do),
    .emio_spi0_sclk_i(emio_spi_sclk),
    .emio_spi0_sclk_o(emio_spi_sclk),
    .emio_spi0_ss0_o_n(emio_spi_cs_b_0),
    .emio_spi0_ss1_o_n(emio_spi_cs_b_1),
    .emio_spi0_ss2_o_n(emio_spi_cs_b_2),
    .emio_spi0_ss_i_n(1'b1),

    .adc_dco_p(adc_dco_P),
    .adc_dco_n(adc_dco_N),
    .adc_data_p({ adc_or_P, adc_d13_P, adc_d12_P, adc_d11_P, adc_d10_P, adc_d9_P, adc_d8_P, adc_d7_P, adc_d6_P, adc_d5_P, adc_d4_P, adc_d3_P, adc_d2_P, adc_d1_P, adc_d0_P }),
    .adc_data_n({ adc_or_N, adc_d13_N, adc_d12_N, adc_d11_N, adc_d10_N, adc_d9_N, adc_d8_N, adc_d7_N, adc_d6_N, adc_d5_N, adc_d4_N, adc_d3_N, adc_d2_N, adc_d1_N, adc_d0_N }),
    .adc_clock_out(adc_clk),
    .dsp_clk(analog_clk_g),
    //.dac_data(dac_data),
